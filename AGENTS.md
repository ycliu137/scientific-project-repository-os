...
- Committing `backend_lab/**/outputs/`; importing `backend_lab` from pipelines/source/tests; or leaving important lab results only inside the lab (use `tex_docs/` promotion)
